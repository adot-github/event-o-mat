<?php
    ...
    $labels = (new Evtmgr_Database_Fields())->get_labels('wp_evtmgr_pricing');
?>
    ...
    $editor->add_table_config([
        ...
        'fields' => [
           ...
           'str_pricing_name_{{lang}}' => [
                'label' => $labels['str_pricing_name_de'] ?? 'str_pricing_name',
                    'formatter' => [
                        'list' => 'actions'
                    ],
           ...
           'num_price' => [
                'label' => $labels['num_price'] ?? 'num_price',
                'acf' => [
                    'type' => 'text',
                ]
            ],
           'dtm_date_valid_from' => [
                'label' => $labels['dtm_date_valid_from'] ?? 'dtm_date_valid_from',
                'acf' => [
                    'type' => 'date_picker'
                ]
            ],
           'dtm_date_valid_to' => [
                'label' => $labels['dtm_date_valid_to'] ?? 'dtm_date_valid_to',
                'acf' => [
                    'type' => 'date_picker'
                ]
            ],
           ...
           'ysn_proof_required' => [
                'label' => $labels['ysn_proof_required'] ?? 'ysn_proof_required',
                'acf' => [
                    'type' => 'true_false',
                ]
            ],
